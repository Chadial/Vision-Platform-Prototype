...
- working now: the current wx shell now also uses the existing recording command/controller surface directly for start/stop actions and display-side recording progress, without introducing a new recording workflow owner
