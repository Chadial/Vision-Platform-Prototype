...
- implemented: UI-free composition of preview focus, snapshot focus, and active ROI into one shared display payload, plus a headless display-geometry service for viewport mapping, zoom, and pan
...
- risk: later interaction work still needs a shared command/action layer above the extracted geometry rules
