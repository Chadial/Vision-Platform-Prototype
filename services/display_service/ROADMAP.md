...
- add optional layer visibility and styling hints if a host really needs them
- compose tracking, drift, or warning overlays into the same payload family

## Deferred

- concrete desktop or browser rendering
