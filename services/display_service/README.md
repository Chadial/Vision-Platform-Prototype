...
- outputs: viewport mappings and coordinate transforms, interaction state transitions, shared preview-status and overlay models, plus shared display payload with active ROI and focus overlays
