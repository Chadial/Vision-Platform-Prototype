...
- architecture note: viewport fitting, zoom, pan, and display-space overlay transforms are intentionally treated as UI/display concerns rather than camera-core concerns, with the reusable geometry rules now owned by `services/display_service`
- residuals:
