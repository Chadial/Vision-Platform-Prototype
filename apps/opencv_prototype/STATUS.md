...
- architecture note: viewport fitting, zoom, pan, interaction semantics, and display-space overlay transforms are intentionally treated as UI/display concerns rather than camera-core concerns, with reusable geometry and interaction rules now owned by `services/display_service`
- residuals:
