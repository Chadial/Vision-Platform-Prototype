...
- partial: anchor hover/drag editing, recording progress display, configuration editing, and broader operator controls are intentionally not part of this first slice
