...
- next: `WP86 Headless Command Seam Extraction Baseline` should now lift one shell-independent command/status seam out of the bounded wx-shell bridge without attempting a broad headless conversion
