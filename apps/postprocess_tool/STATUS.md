...
- implemented: that stable-context summary now also exposes additive traceability control-context fields such as `camera_alias` and profile identity when the current traceability producer path provides them
