...
- known issues: consumers still default to Laplace unless they inject or later select another evaluator path, and full operator-facing overlay toggles and richer metric selection are not wired yet
