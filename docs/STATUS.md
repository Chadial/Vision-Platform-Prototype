...
4. Derive the next narrow post-`WP19` closure slice around explicit focus-summary metadata policy hardening, or another equally bounded metadata/consumer follow-up, instead of reopening broad UI, API, or frontend breadth by default.
