...
3. Select any next work package from concrete residuals, operational friction, or a deliberate new scope decision.
4. Prefer baseline hardening, operational readiness, and controlled productization over broad new breadth by default.
5. Treat broader API growth, additional frontends, larger offline tooling, and C# handover as later post-closure paths rather than current closure obligations.
