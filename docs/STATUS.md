...
- `WP108 Companion Failure Reflection State Extraction` is now the default next non-hardware slice, and `WP109 Companion App-Facing Facade Baseline` remains queued behind it
