...
6. Treat `WP64` as the current next slice so core-backed save/configuration updates are exposed through one bounded menu/settings UX path in the wx shell.
