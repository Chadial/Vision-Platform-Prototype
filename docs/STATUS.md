...
3. Select any next work package from one of four post-closure work types: hardening, operational readiness, selective expansion, or later handover/productization preparation.
4. Prefer hardening and operational readiness over broad new breadth by default.
