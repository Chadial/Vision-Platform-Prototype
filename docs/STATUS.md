...
- first two narrow residual-driven hardening slices
...
3. Use `WP29` through `WP33` as the first explicit post-closure sequence unless a more urgent user-driven residual overrides it.
