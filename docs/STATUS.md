...
6. Treat `WP67` as landed; recording logs now append deterministically within one `save_directory + file_stem` path instead of fragmenting into per-run suffix files.
