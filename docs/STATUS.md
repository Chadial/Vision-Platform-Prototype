...
3. Keep `WP18` visible as the next artifact-metadata follow-up for optional focus and analysis-ROI fields, and do not assume that focus-summary aggregation defaults or bounds are already settled; those still need later testing and definition.
