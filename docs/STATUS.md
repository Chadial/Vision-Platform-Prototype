...
- `WP105 Companion Status Publication Service Extraction` is now the default next non-hardware slice, and `WP106 Companion Runtime Tick Coordinator Baseline` remains queued behind it
