...
- there is no new unconditional non-hardware `current next` after landed `WP106`; derive any further headless-preparation slice explicitly from the remaining residuals instead of widening the current companion runtime lane by inertia
