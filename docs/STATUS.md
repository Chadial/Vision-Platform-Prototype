...
26. Make `WP54` the current next slice.
27. Defer `WP55` unless a concrete operational-help defect outranks `WP54`.
28. Treat broader API growth, additional frontends, larger offline tooling, and C# handover as justified post-closure directions rather than current closure obligations.
