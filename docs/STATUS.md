...
- no unconditional next slice is set after `WP99`; future selection should return to the smallest justified follow-up seam after the now-cleaner local-shell bridge ownership boundary
